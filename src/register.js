                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="input-group">                        
                            <input type="text" ref={this.props.refName} name={this.props.name} onChange={this.props.change} value={this.props.text} className="form-control" placeholder="Digite a informação ..." required/>                    
